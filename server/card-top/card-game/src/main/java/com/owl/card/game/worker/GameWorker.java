...
public class GameWorker extends BaseWorker {
	...
	private int index;
	private static ThreadLocal<GameWorker> workerLocal = new ThreadLocal<GameWorker>();
	...
	private void initSelf() {
		GameWorker nodeWorker = GameWorker.currentWorker();
		if (nodeWorker != null) {
			return;
		}
	...
	public static GameWorker currentWorker() {
